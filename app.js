  ...
  function buildCalendar(year, month) {
    ...
    return `
      ...
      <div style="display:flex;justify-content:flex-end;margin-top:8px">
        <button onclick="refreshCalendar()" title="Recalculate streaks" style="background:none;border:1px solid var(--muted);border-radius:20px;padding:4px 12px;font-size:12px;color:var(--muted);cursor:pointer;display:flex;align-items:center;gap:5px">
          <span style="font-size:13px">↻</span> Refresh streaks
        </button>
      </div>`;
  }
