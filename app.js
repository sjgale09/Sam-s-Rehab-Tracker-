...
function renderHome() {
  ...
  document.getElementById('screen-home').innerHTML = `
    ...
    <div class="card">
      ...
      ${today.journal
        ? `<div style="color:var(--muted);line-height:1.5;margin-bottom:8px;min-height:72px">${today.journal}</div>
           <button class="save-btn" style="padding:10px" onclick="navigate('journal')">Edit Note</button>`
        : `<div style="color:var(--muted);margin-bottom:8px;min-height:72px">No note yet — how are you feeling today?</div>
           <button class="save-btn" style="padding:10px" onclick="navigate('journal')">Add Journal Entry</button>`
      }
    </div>
  `;
