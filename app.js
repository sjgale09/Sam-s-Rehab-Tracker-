...
function calcPainStreak() {
  ...
  today.setHours(0, 0, 0, 0);
  let prev = null;
  // Start from today if a score has been entered, otherwise from yesterday
  ...
  for (let i = startOffset; i <= 365; i++) {
    ...
    if (score === null) break;                // no data for this day — streak ends
    if (prev !== null && prev > score) break; // newer day was worse than older day — streak ends
    prev = score;
    streak++;
  }
  return streak;
